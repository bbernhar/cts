...
**/function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}import { params, poptions, pbool } from '../../../../common/framework/params_builder.js';
...
import { getTexelDataRepresentation } from '../../../util/texture/texelData.js';var

UninitializeMethod;(function (UninitializeMethod) {UninitializeMethod["Creation"] = "Creation";UninitializeMethod["StoreOpClear"] = "StoreOpClear";})(UninitializeMethod || (UninitializeMethod = {}));
...
export class TextureZeroInitTest extends GPUTest {
  ...
  constructor(rec, params) {
    super(rec, params);_defineProperty(this, "stateToTexelComponents", void 0);
